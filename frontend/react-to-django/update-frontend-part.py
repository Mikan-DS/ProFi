...
with open("../react-to-django/template.html", "r", encoding="UTF-8") as file:
    template = file.read()
...
if not os.path.exists("../templates/frontend/"):
    os.makedirs("../templates/frontend", exist_ok=True)
